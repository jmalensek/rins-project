...
ARGUMENTS = [
    ...
    DeclareLaunchArgument('params',default_value=PathJoinSubstitution([pkg_rins_project, 'config', 'slam.yaml']), description='Path to the SLAM Toolbox configuration file')
]
